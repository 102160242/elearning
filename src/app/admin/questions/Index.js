            ...
            <tbody>
              {
                questionsData.data.list && questionsData.data.list.map((i, key) =>
                  <tr key={key}>
                    ...
                    <td>
                      <Link to={"questions/" + i.id} className="mr-3" title="Show"><i className="far fa-eye" style={{ fontSize: "1.3rem",color:"#007bff" }}></i></Link>
                      <Link to={"questions/" + i.id + "/edit"} className="mr-3" title="Edit"><i className="far fa-edit" style={{ fontSize: "1.3rem",color:"#ffc107" }}></i></Link>
