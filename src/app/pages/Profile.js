                                            ...
                                            <div className="row d-flex justify-content-center">
                                                ...
                                                <div className="col-md-9">
                                                    ...
                                                    <div className="d-flex justify-content-center">
                                                        <Link to={"/" + this.props.currentUser.id + "/followers"} className="btn btn-sm btn-outline-success mr-3">Followers <span className="badge">{this.props.currentUser.total_followers}</span></Link>
                                                        <Link to={"/" + this.props.currentUser.id + "/following"} className="btn btn-sm btn-outline-info">Following <span className="badge">{this.props.currentUser.total_following}</span></Link>
                                                    </div>
                                                </div>
